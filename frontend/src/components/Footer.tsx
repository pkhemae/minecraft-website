            ...
            <div className="flex-1">
              <div className="flex flex-col md:flex-row">
                <div className="w-full md:w-1/2 lg:w-1/3 text-left md:pr-4 mb-6 md:mb-0">
                  <h3 className="text-gradient text-2xl md:text-4xl font-bold mb-4">A PROPOS</h3>
                  <p>
                ...
                <div className="w-full md:w-1/2 lg:w-1/3 text-left md:pl-4">
                  <h3 className="text-gradient text-2xl md:text-4xl font-bold mb-4">LIENS UTILES</h3>
